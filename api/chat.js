...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 🌟 [핵심 변경] AI가 무조건 "open_post" 라는 고정된 링크값을 뱉도록 강제
    // 기존 systemPrompt 부분을 아래 내용으로 통째로 교체해 주세요.
...
[출력 예시 양식]
1. 💻 **[컴퓨터와 생성형 AI활용](open_post)**
- 요즘 대세인 생성형 AI를 실무와 일상에서 어떻게 활용하는지 배울 수 있는 유익한 교육이에요!

2. 💼 **[2026년 제8회 춘천시 임기제공무원 채용 재공고](open_post)**
- AI 빅데이터 분석 등 유능한 인재를 찾고 있는 공고입니다.
